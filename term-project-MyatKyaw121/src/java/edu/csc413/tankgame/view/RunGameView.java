...
public class RunGameView extends JPanel {
    ...
    private String AITank1String="";
    private String AITank2String="";
    ...
    public void setTankInfos(int num,String text){
        switch (num) {
            case 1 -> this.playerString = text;
            case 2 -> this.AITank1String = text;
            case 3 -> this.AITank2String = text;
        }
    }
    ...
    private String getAITank1Info(){
        return this.AITank1String;
    }
    private String getAITank2Info(){
        return this.AITank2String;
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString(this.getPlayerInfo(),25,25);
        g.drawString(this.getAITank1Info(), 400,25);
        g.drawString(this.getAITank2Info(),700,25);
